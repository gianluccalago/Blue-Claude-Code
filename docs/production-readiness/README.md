...
1. **31 de 32 contas do projeto de produção têm a senha "blue"**, inclusive contas de gestão e a do Master. Qualquer pessoa que saiba um e-mail entra. Confirmado pelo responsável em 25/09 (consulta no painel do Supabase).
