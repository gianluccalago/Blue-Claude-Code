...
const ICONE_POR_ROTA: Record<string, LucideIcon> = {
  ...
  "/app/medico/testes-cognitivos": Brain,
  ...
  "/app/administracao/hospedes-gestao": Users2,
  "/app/administracao/analise-saidas": TrendingDown,
  "/app/direcao/mapa-suites": MapIcon,
  "/app/direcao/hospedes-inativos": Archive,
  "/app/direcao/hospedes-gestao": Users2,
  "/app/direcao/analise-saidas": TrendingDown,
  "/app/direcao/servicos": Wrench,
  "/app/direcao/enxoval": Shirt,
  "/app/direcao/resultados-nps": BarChart3,
  "/app/direcao/refeicoes-equipe": Soup,
  "/app/direcao/cobranca": CreditCard,
