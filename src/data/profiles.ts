...
export const PERFIS: PerfilDef[] = [
  ...
  },
  {
    ...
    menu: [
      ...
      { label: "Day Care", to: "/app/administracao/day-care" },
      ...
      { label: "Cobrança de temporários", to: "/app/administracao/cobranca-temporaria" },
      ...
      { label: "RH — Eventos de pessoal", to: "/app/administracao/rh-eventos" },
      { label: "RH — Painéis", to: "/app/administracao/rh-paineis" },
      { label: "Custos de materiais", to: "/app/administracao/custos-materiais" },
      { label: "Custo refeições equipe", to: "/app/administracao/refeicoes-equipe" },
  ...
  },
  {
    ...
    menu: [
      ...
      { label: "Day Care", to: "/app/direcao/day-care" },
      ...
      { label: "Cobrança de temporários", to: "/app/direcao/cobranca-temporaria" },
      ...
      { label: "RH — Eventos de pessoal", to: "/app/direcao/rh-eventos" },
      { label: "RH — Painéis", to: "/app/direcao/rh-paineis" },
      { label: "Custos de materiais", to: "/app/direcao/custos-materiais" },
