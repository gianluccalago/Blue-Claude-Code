...
export const PERFIS: PerfilDef[] = [
  {
    ...
    menu: [
      ...
      { label: "CRM — Pipeline", to: "/app/master/crm" },
      { label: "CRM — Tarefas", to: "/app/master/crm-tarefas" },
      { label: "CRM — Relatórios", to: "/app/master/crm-relatorios" },
      { label: "CRM — Contatos", to: "/app/master/crm-contatos" },
      { label: "CRM — Origens", to: "/app/master/crm-origens" },
      { label: "CRM — Configurações", to: "/app/master/crm-config" },
  ...
  },
  {
    ...
    menu: [
      ...
      { label: "CRM — Pipeline", to: "/app/administracao/crm" },
      { label: "CRM — Tarefas", to: "/app/administracao/crm-tarefas" },
      { label: "CRM — Relatórios", to: "/app/administracao/crm-relatorios" },
      { label: "CRM — Contatos", to: "/app/administracao/crm-contatos" },
      { label: "CRM — Origens", to: "/app/administracao/crm-origens" },
      { label: "CRM — Configurações", to: "/app/administracao/crm-config" },
