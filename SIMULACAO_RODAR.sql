-- ============================================================================
-- BLUE SENIOR LIVING — RODAR TUDO DE UMA VEZ (migrações que faltavam + cenário)
-- Cole este arquivo INTEIRO no Supabase (SQL Editor) e clique RUN. É seguro e
-- pode rodar de novo (idempotente). Logins criados com senha: blue
-- ============================================================================

-- ===== PARTE 1/2 · COLUNAS E TABELAS QUE O CENÁRIO PRECISA (migrações 0033–0037) =====
...
-- ===== PARTE 2/2 · O CENÁRIO DA SIMULAÇÃO =====
-- ============================================================================
